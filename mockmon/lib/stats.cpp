...
namespace mockmon
{
  ...
  Stats &Stats::operator+=(const SpeciesStats &otherStats)
  {
  ...
  Stats::Stats(const SpeciesStats &baseStats, const IndividualStats &IVStats, const Stats &EVStats, unsigned int level)
  {
