...
namespace mockmon::moves
{
    ...
    const std::map<moves::MoveId, CompositeMove> CompositeMove::AllCompositeMoves{
        ...
        MakeDictionaryPair<CompositeMove>(MoveId::Screech, CreateNormalAccuracyCheck(85, MovesTargeting::AccuracyEvasion), il_exMV{CreateOpponentStatChangingMove(CreateAllwaysSameChance(true), StatsTypes::Defence, StatModifiersLevels::GreatlyDecreased)}),
